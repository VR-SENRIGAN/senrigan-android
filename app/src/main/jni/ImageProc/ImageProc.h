...
int Java_senrigan_vr_senrigan_1android_MjpegInputStream_pixeltobmp(JNIEnv* env,jobject thiz, jbyteArray jp, jint l, jobject bmp);
void Java_senrigan_vr_senrigan_1android_MjpegInputStream_freeCameraMemory(JNIEnv* env,jobject thiz);
